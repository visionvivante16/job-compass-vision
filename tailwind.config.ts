  ...
  theme: {
    ...
    extend: {
      ...
      colors: {
        ...
        tab: {
          "selected-bg": "hsl(var(--tab-selected-bg))",
          "selected-text": "hsl(var(--tab-selected-text))",
        },
        popover: {
